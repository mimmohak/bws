...
const string strMessageMagic = "bitcoinwallstreet Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 20) // BWS
    {
        nSubsidy = 5000000 * COIN;
    }
    else if(pindexBest->nHeight < 9000000) // backup
    {
        nSubsidy = 0 * COIN;
    }
...
// bitcoinwallstreet: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bitcoinwallstreet", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BWS genesis";
        CTransaction txNew;
        txNew.nTime = 1513252780;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xf6f19ee4ad6fb2c08e591eec055e729534ca7f9ce3d2babcdcebc3a1bcaa486d"));
        block.print();
